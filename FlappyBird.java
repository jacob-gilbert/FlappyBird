...
public class FlappyBird extends JPanel implements ActionListener, KeyListener { //FlappyBird inherits from JPanel
    int boardWidth = 360;
    int boardHeight = 640;
    ...
    public void placePipes() {
        ...
        // 0 - 128 - (0-256) -> pipeHeight/4 to 3/4 pipeHeight
